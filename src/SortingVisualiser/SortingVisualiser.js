...
class SortingVisualiser extends React.Component {
  ...
  sort () {
    ...
    if (algo === MERGESORT) animations = mergeSortAnimations(this.state.arr)
      ...
      animations = selectionSortAnimations(this.state.arr)
    else if (algo === QUICKSORT)
      animations = quickSortAnimations(this.state.arr)
    else if (algo === INSERTIONSORT)
      animations = insertionSortAnimations(this.state.arr)
          ...
          <ButtonToolbar aria-label='Toolbar with button groups'>
            ...
            >
              ...
              <ToggleButton
                variant='outline-dark'
                value={3}
                onClick={() => this.setArraySize(200)}
              >
                200
              </ToggleButton>
            </ToggleButtonGroup>
            <ButtonGroup aria-label='Third group'>
              <Button variant='light' onClick={() => this.sort()}>
                Sort
              </Button>
            </ButtonGroup>
          </ButtonToolbar>
